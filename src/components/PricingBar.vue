<template>
<div class="tab-pane fade show active row row-cols-1 row-cols-md-4 mb-3" id="export" role="tabpanel"
        ...
        <div class="tab-pane fade row row-cols-1 row-cols-md-4 mb-3" id="publish" role="tabpanel"
